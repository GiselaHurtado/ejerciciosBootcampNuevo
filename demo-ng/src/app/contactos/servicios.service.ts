...
import { NavigationService, NotificationService } from '../common-services/navigation.service';
...
export class ContactosDAOService extends RESTDAOService<Contacto, number> {
  constructor() {
    super('contactos', { context: new HttpContext() });
  }
...
export class ContactosViewModelService {
  ...
  // Se inyecta Router y NavigationService para navegación
  constructor(
  ...
  imageErrorHandler(event: Event, item: any) {
    (event.target as HTMLImageElement).src = item.sexo === 'H'
      ? '/images/user-not-found-male.png'
      : '/images/user-not-found-female.png';
  }
}
